...
public class RegistrationTestsRA {
    ...
    public void registrationWrongEmail() throws IOException {
              AuthRequestDto auth = AuthRequestDto.builder().username("bqamail.ru").password("bQa$1234").build();
    ...
    public void registrationWrongPassword() throws IOException {
        AuthRequestDto auth = AuthRequestDto.builder().username("bqa@mail.ru").password("bQa$").build();
    ...
    @Test
    public void registrationDublicate() throws IOException {
